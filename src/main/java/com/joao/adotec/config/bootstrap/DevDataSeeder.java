...
/**
 * Componente responsável pelo bootstrap de dados essenciais para o ambiente de
 * desenvolvimento.
 * ATENÇÃO: Esta classe deve ser executada APENAS quando o profile "dev" estiver
 * ativo.
 * Isso resolve o BUG-01 e evita a criação de credenciais conhecidas em ambiente
 * de produção.
 */
@Component
@Profile("dev")
...
public class DevDataSeeder implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                if (!userRepository.existsByEmail("employee@adotec.com")) {
                        ...
                        User employee = new User("Employee User", "employee@adotec.com",
                ...
                if (!userRepository.existsByEmail("adopter@adotec.com")) {
                        ...
                        User adopter = new User("Adopter User", "adopter@adotec.com",
                                        passwordEncoder.encode("adopter123"));
        ...
        private void seedPets() {
                ...
                // ── Cachorros ───────────────────────────────────────────
                createPet("Rex", "Cachorro", PetSize.BIG, PetGender.MALE, 36,
                ...
                createPet("Luna", "Cachorro", PetSize.MEDIUM, PetGender.FEMALE, 18,
                ...
                createPet("Thor", "Cachorro", PetSize.BIG, PetGender.MALE, 24,
                ...
                createPet("Mel", "Cachorro", PetSize.SMALL, PetGender.FEMALE, 8,
                ...
                createPet("Bob", "Cachorro", PetSize.MEDIUM, PetGender.MALE, 48,
                ...
                createPet("Pipoca", "Cachorro", PetSize.SMALL, PetGender.FEMALE, 12,
                ...
                // ── Gatos ───────────────────────────────────────────────
                createPet("Mimi", "Gato", PetSize.SMALL, PetGender.FEMALE, 6,
                ...
                createPet("Simba", "Gato", PetSize.MEDIUM, PetGender.MALE, 30,
                ...
                createPet("Nina", "Gato", PetSize.SMALL, PetGender.FEMALE, 4,
                ...
                createPet("Felix", "Gato", PetSize.MEDIUM, PetGender.MALE, 60,
                ...
                // ── Outros ──────────────────────────────────────────────
                createPet("Cenoura", "Coelho", PetSize.SMALL, PetGender.FEMALE, 14,
                ...
                createPet("Bolt", "Cachorro", PetSize.BIG, PetGender.MALE, 20,
        ...
        private void createPet(String name, String species, PetSize size, PetGender gender, int ageInMonths,
